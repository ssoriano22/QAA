...
def get_args():
    parser = argparse.ArgumentParser(description="A program to count mapped and unmapped primary alignments in STAR-output SAM file.")
...
# file = "STAR_align_mm_11_2H_both_S9_L008Aligned.out.sam"
